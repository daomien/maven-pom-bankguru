...
public class Level_16_Register_Login_Jackson_Data_02 extends BaseTest {

	WebDriver driver;
	DataJson userData;
	String emailAddress, password, firstName, lastName;
	String postFixEmail = getIntRandom() + "@gmail.com";
	...
	public void initBrowser(String browserName, String url) {
		...
		userData = DataJson.getFile(GlobalConstants.PROJECT_LOCATION_PATH + "/src/main/java/com/nopcommerce/data/UserData.json");
		emailAddress = userData.getPreFixEmail() + postFixEmail;
	...
	public void Login_01_Register_To_System() {
		...
		log.info("Login_01_Register_To_System: STEP 04 - Enter first name '" + firstName + "'");
		registerPage.enterToTextboxById(driver, firstName, "FirstName");

		log.info("Login_01_Register_To_System: STEP 05 - Enter last name '" + lastName + "'");
		registerPage.enterToTextboxById(driver, lastName, "LastName");

		log.info("Login_01_Register_To_System: STEP 06 - Enter email address '" + emailAddress + "'");
		registerPage.enterToTextboxById(driver, emailAddress, "Email");

		log.info("Login_01_Register_To_System: STEP 07 - Enter password '" + password + "'");
		registerPage.enterToTextboxById(driver, password, "Password");

		log.info("Login_01_Register_To_System: STEP 08 - Enter confirm password '" + password + "'");
	...
	public void Login_02_Login_To_System() {
		...
		log.info("Login_02_Login_To_System: STEP 02 - Login page - Enter email address '" + emailAddress + "'");
		loginPage.enterToTextboxById(driver, emailAddress, "Email");

		log.info("Login_02_Login_To_System: STEP 03 - Login page - Enter password '" + password + "'");
